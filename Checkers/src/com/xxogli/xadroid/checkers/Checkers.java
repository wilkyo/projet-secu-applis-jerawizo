...
public class Checkers extends Activity {
	...
	public void onCreate(Bundle paramBundle) {
		...
		this.view = new b(this, getPreferences(0));
	...
	public boolean onKeyDown(int paramInt, KeyEvent paramKeyEvent) {
		...
		case 23:
			...
			return true;
		case 21:
			this.view.a(-1.0F, 0.0F);
			return true;
		case 22:
			this.view.a(1.0F, 0.0F);
			return true;
		case 19:
			this.view.a(0.0F, -1.0F);
			return true;
		case 20:
		}
		this.view.a(0.0F, 1.0F);
	...
	public boolean onOptionsItemSelected(MenuItem paramMenuItem) {
		...
		case 1:
			do {
				...
				if (i == 2) {
					paramMenuItem.setChecked(this.view.c(true));
					return true;
				}
				if (i == 3) {
	...
	public boolean onTrackballEvent(MotionEvent paramMotionEvent) {
		...
		this.view.a(paramMotionEvent.getX(), paramMotionEvent.getY());
		return true;
	}
}
