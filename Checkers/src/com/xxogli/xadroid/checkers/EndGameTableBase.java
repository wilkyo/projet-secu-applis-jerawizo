...
public class h
{
  ...
  public static void a(Context paramContext)
  {
    try
    {
      ...
      p = new byte[10584];
      q = new byte[246016];
      s = new BufferedInputStream(paramContext.getResources().openRawResource(2130903040), 8192);
      a(a);
      a(b);
      a(c);
      a(d);
 ...
 * Qualified Name:     com.xxogli.xadroid.checkers.h
